...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The queue was adding the new values at the beggining, working as a Stack instead of like a queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The case to handle Zero was not implemented, it would have just dequeued.
    ...
    // Defect(s) Found: The case to handle negative numbers was not implemented, it would have just dequeued.
    ...
    // Defect(s) Found: Case was handled correctly.
